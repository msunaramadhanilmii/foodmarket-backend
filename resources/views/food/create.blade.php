                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-600 text-xs italic">
                                Dipisahkan dengan koma, contohnya Bawang Merah, Paprika, Timun.
                            </p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input value="{{ old('types') }}" name="types"
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" step="0.01" max="5"
                                placeholder="Food Types">
                            <p class="text-gray-600 text-xs italic">
                                Dipisahkan dengan koma, contohnya recommended, popular, new_food.
                            </p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
